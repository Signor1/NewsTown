...
const SingleMovieC = ({ title, singleData }) => {
  ...
  return (
    <div className="w-full lg:col-span-2 py-8 md:pl-8 lg:pr-0 md:pr-8">
      ...
      <div className="w-full mt-12">
        ...
        <ol className="relative border-l border-gray-400 my-8 md:ml-0">
          <li className="mb-8 ml-4">
            <div className="absolute w-3 h-3 bg-naija rounded-full mt-1.5 -left-1.5 border border-white"></div>
            <h3 className="md:text-lg text-sm my-4 flex gap-2 flex-wrap font-semibold text-naija">
              Name :<span className="text-gray-300">{singleData[0].title}</span>
            </h3>
          </li>
          <li className="mb-8 ml-4">
            <div className="absolute w-3 h-3 bg-naija rounded-full mt-1.5 -left-1.5 border border-white"></div>
            <h3 className="md:text-lg text-sm my-4 flex gap-2 flex-wrap font-semibold text-naija">
              Genre:
              <span className="text-gray-300">{singleData[0].genre}</span>
            </h3>
          </li>
          {singleData[0].stars ? (
            <li className="mb-8 ml-4">
              ...
              <h3 className="md:text-lg text-sm my-4 flex gap-2 flex-wrap font-semibold text-naija">
                Stars:
                <span className="text-gray-300">{singleData[0].stars}</span>
              </h3>
            </li>
          ) : (
            ""
          ...
          {singleData[0].imdb ? (
            <li className="mb-8 ml-4">
              ...
              <h3 className="md:text-lg text-sm my-4 flex gap-2 flex-wrap font-semibold text-naija">
                IMDB:
                <a
                  href={singleData[0].imdb}
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-300 hover:text-naija hover:underline transition-all duration-200"
                >
                  {singleData[0].imdb}
                </a>
              </h3>
          ...
          {singleData[0].mydramalist ? (
            <li className="mb-8 ml-4">
              <div className="absolute w-3 h-3 bg-naija rounded-full mt-1.5 -left-1.5 border border-white"></div>
              <h3 className="md:text-lg text-sm my-4 flex gap-2 flex-wrap font-semibold text-naija">
                MyDramaList:
                <a
                  href={singleData[0].mydramalist}
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-300 hover:text-naija hover:underline transition-all duration-200"
                >
          ...
          <li className="mb-8 ml-4">
            ...
            <h3 className="md:text-lg text-sm my-4 flex gap-2 flex-wrap font-semibold text-naija">
              Premiere:
              <span className="text-gray-300">{singleData[0].premiere}</span>
            </h3>
          </li>
        </ol>
