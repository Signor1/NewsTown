...
const SingleMedia = ({ title, singleData }) => {
    ...
    <div className="w-full lg:col-span-2 py-8 md:pl-8 lg:pr-0 md:pr-8">
      ...
      <div className="w-full mt-12">
        <Fade direction="up" duration={500}>
          ...
          <div className="w-full grid md:grid-cols-3 gap-8 md:h-96 my-4 ">
            <div className="border md:h-96 md:col-span-2 border-slate-300 rounded-lg">
              <img
                src={singleData[0].img}
                alt="NewsImage"
                className="rounded-lg object-cover object-top block w-full h-full"
              />
            </div>
            <div className="w-full self-center">
              <ol className="relative border-l border-gray-400 ml-6 md:ml-0">
