...
const PageMusicC = ({ title, pageData, url }) => {
            ...
            <Fade direction="up" duration={500} key={index}>
              <div className="bg-slate-800 h-auto rounded-lg border border-slate-600 shadow-md relative">
                ...
                <div className="px-3 py-4 w-full">
                  ...
                  <ul className="list-none flex justify-between text-slate-400 text-sm font-light font-poppins w-full">
                    {data.singer ? (
                      <li className="flex items-center text-naija gap-1">
